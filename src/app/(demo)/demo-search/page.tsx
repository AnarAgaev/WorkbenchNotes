		...
		<Container className="py-10">
			<section className="app-card">
				...
				<p className="muted mt-2 text-sm">
					searchParams приходит из query-строки URL. Один ключ может
					отсутствовать, встречаться один раз или повторяться несколько раз.
				</p>
				...
				<div className="mt-5 grid gap-3 app-card app-card--soft">
					...
					<p className="muted pt-2 text-xs">
						Эта страница ничего не валидирует. Она показывает, что именно пришло
						из URL.
					</p>
				</div>
				<div className="mt-6 app-card app-card--soft text-sm">
					...
					<p className="muted mt-3 text-xs">
						normalised значения имеют тип string | undefined. Для массива
